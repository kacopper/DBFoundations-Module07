...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_KatherineCopper')
	 Begin 
	  Alter Database [Assignment07DB_KatherineCopper] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_KatherineCopper;
	 End
	Create Database Assignment07DB_KatherineCopper;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_KatherineCopper;
